        ...
        <div class="wrap-container">
            <section class="index-content" data-scroll-section data-scroll-section-id="section101" data-scroll-section-inview>
                <div class="project__main__text">
                    <h1 class="project__title section-head__title title-medium">Žene</h1>
                    <div class="project__text section-head__subtitle">
                        <p>Osvojite pažnju u Baron modelima, čija elegancija ostavlja neizbrisiv trag. Budite ono što se pamti.</p>
                    </div>
                </div>
            </section>
            <?php if (have_posts()) : ?>
