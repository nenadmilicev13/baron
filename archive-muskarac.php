        ...
        <div class="wrap-container">
            <section class="index-content" data-scroll-section data-scroll-section-id="section101" data-scroll-section-inview>
                <div class="project__main__text">
                    <h1 class="project__title section-head__title title-medium">Muškarci</h1>
                    <div class="section-head__subtitle">
                        <p>Baron unikatni modni detalji su sinonim za eleganciju, odvažnost i stil - sve ono što treba da isprati vašu posebnu priliku.</p>
                    </div>
                </div>
            </section>
            <?php if (have_posts()) : ?>
            ...
            <?php else : ?>
                <p>Nema postova u CPT 'muskarac'.</p>
            <?php endif; ?>
