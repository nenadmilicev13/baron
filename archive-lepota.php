        ...
        <div class="wrap-container">
            <section class="index-content" data-scroll-section data-scroll-section-id="section101" data-scroll-section-inview>
                <div class="project__main__text">
                    <h1 class="project__title section-head__title title-medium">Lepota</h1>
                    <div class="section-head__subtitle">
                        <p>Baron beauty tim stvara jedinstvenu i nezaboravnu priču o vašoj lepoti, kako biste se osećali i izgledali sjajno tokom najvažnijih životnih trenutaka.</p>
                    </div>
                </div>
            </section>
            <?php if (have_posts()) : ?>
